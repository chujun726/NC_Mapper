...
class LakesLayer(Layer):
    """
    地圖的湖泊圖層。
    """

    def __init__(self, resolution='10m', line_color='#1E1E1E', line_width=0.15, face_color=(0, 0, 0, 0), is_visible=True):
        """
        建立一個湖泊圖層。
